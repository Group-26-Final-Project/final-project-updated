...
const CustomChartTwo = (props) => {
  console.log(props.reports, "props");
  const reports = props.reports;
  const data = [
    { name: 'Registered Students', value: (reports.totalUsers - 1) / reports.totalStudents },
    { name: 'Unregistered Students', value: (reports.totalStudents - reports.totalUsers - 1) / reports.totalStudents }
  ];
