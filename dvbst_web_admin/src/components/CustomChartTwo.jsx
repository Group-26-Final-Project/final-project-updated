...
const CustomChartTwo = (props)=> {
  ...
  const data = [
    { name: 'Registered Voters', value: reports.totalVoters/reports.totalUsers },
    {name: 'Unregistered Voters', value: (reports.totalusers - reports.allvoters)/reports.totalusers}
  ];
